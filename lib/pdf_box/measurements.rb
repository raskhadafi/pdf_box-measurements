...
module PdfBox
  #
  # Module PdfBox::Measurements provides conversions from other measurements to PDF points
  # Inspired by 'prawn/measurements'
  #
...
require_relative 'measurements/numeric'
